...
public class TagFactory {
	...
	public static Tag createTag(VINT id, VINT size, byte[] data) throws ConverterException {
		...
		try {
			return (Tag) nt.clazz
					.getConstructor(String.class, VINT.class, VINT.class, byte[].class)
					.newInstance(nt.name, id, size, data);
		} catch (Exception e) {
